...
public class Constant {
	...
	public static String MASTER_DATASOURCES_XML_PATH = CarbonUtils.getCarbonHome() +
	                                                   File.separator + "repository" +
	                                                   File.separator + "conf" + File.separator +
	                                                   "datasources" + File.separator +
	                                                   "master-datasources.xml";

	public static final String CARBON_XML_PATH = CarbonUtils.getCarbonHome() + File.separator +
	                                             "repository" + File.separator + "conf" +
	                                             File.separator + "carbon.xml";

	public static final String LOG4J_PROPERTY_PATH = CarbonUtils.getCarbonHome() + File.separator +
	                                                 "repository" + File.separator + "conf" +
